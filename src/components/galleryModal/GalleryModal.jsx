...
function GalleryModal({ key, item, lensID, opened, onClose, image, video, title, date, citations, description, categories, projectLink }) {
                                ...
                                <Badge radius='xl' style={
                                    item.win.position === 0 ? { backgroundColor: '#FFB400', color: '#474747' } :
                                        item.win.position === 1 ? { backgroundColor: '#A4A4A4', color: '#F1F1F1' } :
                                            item.win.position === 2 ? { backgroundColor: '#8a5521ff', color: '#F1F1F1' } :
                                                { color: '#FFFFFF' }
                                }>
